...
app.use('/api/depositos-totales', require('./routes/depositos-totales.routes'));
app.use('/api/bonos-totales', require('./routes/bonos-totales.routes'));
app.use('/api/retiros-totales', require('./routes/retiros-totales.routes'));
app.use('/api/retiros-no-pagados', require('./routes/retiros-no-pagados.routes'));
